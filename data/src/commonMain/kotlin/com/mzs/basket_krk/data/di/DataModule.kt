...
import com.mzs.basket_krk.data.repository.TeamRepositoryImpl
...
val dataModule = module {
    ...
    single<SearchService> { NetworkSearchService(get()) }
    single<LeagueService> { NetworkLeagueService(get()) }
